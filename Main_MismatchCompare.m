...
load('OptPd111415.mat')
plot(SNR,pd_expand_opt,'-*','linewidth',1.5,'markersize',8);hold on;
linesty={'-+','-o','-d','-s','-<'};
for h=1:mismatch_num
...
legend('Optimal weights','$\hat{\rho}_\lambda$=1:1:14:15,$\hat{\lambda}_0$=9dB','$\hat{\rho}_\lambda$=1:1:1:1,$\hat{\lambda}_0$=9dB','$\hat{\rho}_\lambda$=4:3:2:1,$\hat{\lambda}_0$=9dB'...
     ,'$\hat{\rho}_\lambda$=1:1:14:15,$\hat{\lambda}_0$=1dB','$\hat{\rho}_\lambda$=1:1:14:15,$\hat{\lambda}_0$=17dB','SGLRT','MGLRT','Interpreter','latex');
%  legend('Optimal weights','$\hat{\rho}_\lambda$=10:6:2:1,$\hat{\lambda}_0$=9dB','$\hat{\rho}_\lambda$=1:1:1:1,$\hat{\lambda}_0$=9dB','$\hat{\rho}_\lambda$=1:2:3:4,$\hat{\lambda}_0$=9dB'...
